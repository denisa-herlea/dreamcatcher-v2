...
from .charts import StressChartCreator, EnergyChartCreator, DurationChartCreator, ChartCreator
...
def statistici_view_stres_week(request):
    ...
    chart_creator_stress = ChartCreator(stress_chart_creator)
...
def statistici_view_energie_week(request):
    ...
    chart_creator_energy = ChartCreator(energy_chart_creator)
...
def statistici_view_durata_week(request):
    ...
    chart_creator_duration = ChartCreator(duration_chart_creator)
